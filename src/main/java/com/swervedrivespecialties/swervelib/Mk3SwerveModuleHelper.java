...
public final class Mk3SwerveModuleHelper {
    ...
    private static SteerControllerFactory<?, NeoSteerConfiguration<SparkMAXEncoderAbsoluteConfiguration>> getNeoSteerFactory(Mk3ModuleConfiguration configuration) {
    ...
    public static SwerveModule createNeo(
        ...
        return createNeo(container, new Mk3ModuleConfiguration(), gearRatio, driveMotorPort, steerMotorPort, steerEncoderPort);
    }
    ...
    public static SwerveModule createNeo(
        ...
        return createNeo(new Mk3ModuleConfiguration(), gearRatio, driveMotorPort, steerMotorPort, steerEncoderPort);
    }
