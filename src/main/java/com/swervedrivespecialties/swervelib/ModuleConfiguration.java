...
public class ModuleConfiguration {
     ...
     *                              this is typically true.
     * @param steerEncoderInverted  Whether the steer encoder should be inverted. Check the encoder to see if it moves in the
     *                              same or opposite direction as the module rotates.
     */
    public ModuleConfiguration(double wheelDiameter, double driveReduction, boolean driveInverted,
                               double steerReduction, boolean steerInverted, boolean steerEncoderInverted) {
    ...
    /**
     * Gets if the steering encoder should be inverted.
     */
    public boolean isSteerEncoderInverted() {
        return steerEncoderInverted;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.getWheelDiameter(), getWheelDiameter()) == 0 &&
                ...
                isSteerEncoderInverted() == that.isSteerEncoderInverted();
    }
