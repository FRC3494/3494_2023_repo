...
public class Arm extends SubsystemBase {
    ...
    void correctForearmNeo() {
        forearmMotor.getEncoder().setPosition(
                (-getAbsoluteEncoderForearmAngle() / 360.0) / Constants.Subsystems.Arm.FOREARM_MOTOR_REDUCTION);
    }
    ...
    boolean isAtForearmState(ForearmState state) {
        boolean there = Math.abs(getForearmAngle() - Constants.Subsystems.Arm.FOREARM_POSITION
                .get(currentForearmState)) <= Constants.Subsystems.Arm.FOREARM_TARGET_POSITION_TOLERANCE;
    ...
    boolean isAtHopperState(HopperState state) {
        return (System.currentTimeMillis() - lastHopperActuationTime) >= 500; // we don't actually have a sensor for
                                                                              // this, might as well have a way just in
                                                                              // case though
    }
    ...
    TransitionGraphNode begin(TransitionGraphNode next) {
        return new TransitionGraphNode(() -> isDoneMoving = false, () -> true, next);
    }
    ...
    TransitionGraphNode parallelMovement(ForearmState newForearmState, ShoulderState newShoulderState,
    ...
    TransitionGraphNode parallelMovement(ForearmState newForearmState, HopperState newHopperState,
            TransitionGraphNode next) {
        return new TransitionGraphNode(
                () -> {
                    setForearmState(newForearmState);
    ...
    TransitionGraphNode parallelMovement(ShoulderState newShoulderState, HopperState newHopperState,
            TransitionGraphNode next) {
        return new TransitionGraphNode(
                () -> {
                    setShoulderState(newShoulderState);
    ...
    TransitionGraphNode parallelMovement(ForearmState newForearmState, ShoulderState newShoulderState,
            HopperState newHopperState, TransitionGraphNode next) {
        return new TransitionGraphNode(
                () -> {
                    setForearmState(newForearmState);
                    setShoulderState(newShoulderState);
    ...
    void populateLowerHopperGrabGraph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.LowerHopperGrab, new TransitionGraph(begin(
    ...
    void populateUpperHopperGrabGraph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.UpperHopperGrab, new TransitionGraph(begin(
                // forearmMovement(ForearmState.HopperGrab,
                new TransitionGraphNode(() -> currentShoulderState == ShoulderState.Base4,
                        forearmMovement(ForearmState.DoubleSubstation,
                                hopperMovement(HopperState.Extended,
    ...
    void populateGroundIntakeGraph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.GroundIntake, new TransitionGraph(begin(
    ...
    void populateDoubleSubstationGraph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.DoubleSubstation, new TransitionGraph(begin(
                // forearmMovement(ForearmState.DoubleSubstation,
                new TransitionGraphNode(() -> currentShoulderState == ShoulderState.Base4,
                        forearmMovement(ForearmState.DoubleSubstation,
                                done()),
    ...
    void populateHybridGraph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.Hybrid, new TransitionGraph(begin(
    ...
    void populateStoreGraph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.Store, new TransitionGraph(begin(
                // forearmMovement(ForearmState.Store,
                new TransitionGraphNode(() -> currentShoulderState == ShoulderState.Base4,
                        hopperMovement(HopperState.Extended,
                                forearmMovement(ForearmState.DoubleSubstation,
    ...
    void populateBase4Cone2Graph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.Base4Cone2, new TransitionGraph(begin(
    ...
    void populateBase4Cube2Graph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.Base4Cube2, new TransitionGraph(begin(
    ...
    void populateBase4Cube1Graph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.Base4Cube1, new TransitionGraph(begin(
    ...
    void populateBase2Cone1Graph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.Base2Cone1, new TransitionGraph(begin(
    ...
    void populateBase1Cube1Graph() {
        ...
        armStateMachine.addTransitionGraph(null, ArmPosition.Base1Cube1, new TransitionGraph(begin(
