...
public class Arm extends SubsystemBase  {
    ...
    void populateHopperGrabGraph() {
        armStateMachine.addBehaviour(ArmPosition.HopperGrab, () -> {});
        armStateMachine.addTransitionGraph(null, ArmPosition.HopperGrab, new TransitionGraph(
